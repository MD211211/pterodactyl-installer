# :bird: pterodactyl-installer BUT BETTER
...
## credits
i did not make this install script i just improved it. How you may ask?
well i made it install yarn and forward ports NOT with ufw but with firewalld.
